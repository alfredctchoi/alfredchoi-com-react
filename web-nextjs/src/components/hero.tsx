...
export default function Hero() {
  return (
    <section className="shell pt-24 pb-16 max-md:pt-14 max-md:pb-10">
      <div className="mb-14">
        <FadeIn>
          <span className="font-mono text-[11px] tracking-[0.08em] uppercase font-medium text-fg">
      ...
      <FadeIn delay={120}>
        <h1 className="font-sans font-medium text-[clamp(44px,8.2vw,128px)] leading-[0.95] tracking-[-0.035em] mb-14 max-md:mb-10" style={{ textWrap: "balance" }}>
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
          {metaCells.map(({ label, value }, i) => (
            <FadeIn key={label} delay={160 + i * 60}>
              <span className="block mb-2.5 font-mono text-[11px] tracking-[0.08em] uppercase font-medium text-muted">
                {label}
              </span>
