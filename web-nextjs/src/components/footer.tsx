export default function Footer() {
  return (
    <footer className="mx-auto max-w-[1440px] px-8 border-t border-rule-strong py-8 pb-12 font-[family-name:var(--mono)] text-[11px] text-muted tracking-[0.04em] grid grid-cols-2 md:grid-cols-4 gap-6">
      <div>
