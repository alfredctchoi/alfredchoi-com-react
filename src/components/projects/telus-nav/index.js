  ...
  return (
    <Row>
      <Col xs={12} md={6}>
        ...
        <h3>Background</h3>
        <Paragraph>In the previous version of My TELUS, the navigation menu did not have the logic to serve all the different customer segments.  For example, corporate users would require a different navigation menu context than a regular consumer.  Our team set out to solve the following problems for this project:</Paragraph>
        <ul>
          <li>
            <Paragraph>
